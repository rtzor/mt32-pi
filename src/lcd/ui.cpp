...
m_SysExPixelBuffer{0},
          ...
          m_fMenuReverbWidth(0.5f),
          m_bMenuChorusActive(true),
          m_fMenuChorusDepth(8.0f),
          m_fMenuChorusLevel(2.0f),
          m_nMenuChorusVoices(3),
          m_fMenuChorusSpeed(0.3f),
          m_fMenuGain(0.2f),
          m_nMenuROMSet(0),
          m_nMenuSoundFont(0)
,
		  m_fMenuMT32Gain(1.0f),
		  m_fMenuMT32ReverbGain(1.0f),
		  m_bMenuMT32ReverbEnabled(true),
		  m_bMenuMT32NiceAmpRamp(true),
		  m_bMenuMT32NicePanning(false),
		  m_bMenuMT32NicePartMix(false),
		  m_nMenuMT32DACMode(0),
